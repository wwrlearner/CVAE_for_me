...
def add_default_data_parser(parser):
    # Data & logging path
    parser.add_argument('--data', type=str, default='neural')
    parser.add_argument('--data_dir', type=str, default='/root/demvae_remix/data/neural')
    parser.add_argument('--log_dir', type=str, default='/root/demvae_remix/logs/neural')
    # Draw points
...
def get_parser(model_class="sent_models"):
    ...
    parser.add_argument('--model', type=str, default="GMVAE") # 加载模型
